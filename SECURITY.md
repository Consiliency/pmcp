...
- The approval store is content-keyed and user-scoped, and a store resident in the served project, in a checkout enclosing it, or in the launch checkout is refused whether reached directly or through a symlink; an approval recorded in such a store grants nothing [C-15].
